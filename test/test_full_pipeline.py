...
from src.pipeline import api_client, data_cleaner, bf2_rename_map, influx_writer
import datetime
...
class TestFullPipeline(unittest.TestCase):
    ...
    def test_fetch_and_clean_daily(self, mock_et, mock_get):
        ...
        mock_response.text = '<string>[{"Timelogged": "05/29/2025 12:00:00 AM", "var1": 123}]</string>'
        mock_get.return_value = mock_response
        mock_et.return_value.text = '[{"Timelogged": "05/29/2025 12:00:00 AM", "var1": 123}]'
    ...
    @patch('src.pipeline.bf2_rename_map.build_points', return_value='measurement field=1 1234567890\n')
    def test_process_and_write_integration(self, mock_build_points, mock_write_points_to_txt):
        """Integration: process_and_write processes cleaned data and writes to file."""
        cleaned_list = [{
            'Timelogged': '05/29/2025 12:00:00 AM',
            'var1': 123
        }]
        args = MagicMock()
        args.db_write = False
    ...
    def test_process_datewise_pipeline(self, mock_log_run, mock_process_and_write, mock_clean, mock_fetch):
        """Integration: process_datewise runs the full pipeline and logs run."""
        mock_fetch.return_value = '[{"Timelogged": "05/29/2025 12:00:00 AM", "var1": 123}]'
        mock_clean.return_value = [{"Timelogged": "05/29/2025 12:00:00 AM", "var1": 123}]
        mock_process_and_write.return_value = (1, 'file.txt', None)
        dt = datetime.date(2025, 5, 29)
        args = argparse.Namespace(mode='daily', db_write='False', log_run='True', override='True', retain_file='False', debug='False', delay=120, use_db_params='False', db_host=None, db_org=None)
