...
class TestUtils(unittest.TestCase):
    ...
    def test_check_existing_data(self):
        ...
        self.assertFalse(utils.check_existing_data([{'a': 1}], args=None))
    ...
    def test_setup_run_logging_yaml(self):
        ...
        log_path = utils.setup_run_logging_yaml('05-29-2025', time_str='120000', mode='live', range_param='1', pid=12345, log_dir='test_logs', yaml_path='config/logging.yaml')
