...
class TestApiClient(unittest.TestCase):
    ...
    def test_process_datewise_success(self, mock_log_run, mock_process_and_write, mock_clean, mock_fetch):
        ...
        api_client.process_datewise(dt, 1, True, args=argparse.Namespace(mode='daily'), log_path='log.txt')
